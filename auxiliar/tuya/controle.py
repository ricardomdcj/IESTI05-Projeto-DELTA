...
DPS_MAP = {
    ...
    "lampada": {
        "modo": "multi",   # especial: envia vários DPS (21, 22, 23)
        "brilho": "22",
        "temp": "23",
    },
}
...
def mostrar_ajuda():
    ...
    print("  python controle.py interruptor ventilador on/off")
    print("  python controle.py interruptor speed 1-5")
    print("  python controle.py interruptor lamp on/off")
    print("\nAr-condicionado")
    print("  python controle.py ar switch on/off")
    print("  python controle.py ar temp 24")
    print("  python controle.py ar mode cold")
    print("  python controle.py ar wind off       # equivale a mute")
    print("  python controle.py ar wind high")
    print("  python controle.py ar eco on/off")
    print("  python controle.py ar light on/off")
    print("  python controle.py ar swing on/off")
    print("  python controle.py ar sleep on/off")
    print("  python controle.py ar health on/off")
    print("  python controle.py ar lock on/off")
    print("\nLâmpada (ID eb5190d6da3b29f59bmm7b)")
    print("  python controle.py lampada modo dia")
    print("  python controle.py lampada modo noite")
    print("  python controle.py lampada brilho 60")
    print("  python controle.py lampada temp quente")
    print("\nStatus")
    print("  python controle.py <interruptor|ar|lampada> status")
    print("=" * 70)
